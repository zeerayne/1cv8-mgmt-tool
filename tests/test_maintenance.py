...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_type_when_succeeded(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_type_when_succeeded_with_v8(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_type_when_succeeded_with_pg(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_type_when_succeeded_with_v8_and_pg(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_type_when_failed(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_type_when_failed_with_v8(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_type_when_failed_with_pg(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_type_when_failed_with_v8_and_pg(mocker: MockerFixture, infobase):
    """
    Maitenance infobase function returns result of `InfoBaseMaintenanceTaskResult` 
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_succeeded_when_succeeded(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_succeeded_when_succeeded_with_v8(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_succeeded_when_succeeded_with_pg(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_succeeded_when_succeeded_with_v8_and_pg(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_failed_when_failed(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_failed_when_failed_with_v8(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_failed_when_failed_with_pg(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_failed_when_failed_with_v8_and_pg(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_type_when_rotate_logs_raises_error(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_type_when_v8_raises_error(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_type_when_pg_raises_error(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_failed_when_rotate_logs_raises_error(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_failed_when_v8_raises_error(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_returns_maintenance_result_failed_when_pg_raises_error(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_calls_rotate_logs_by_default(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_calls_maintenance_v8_with_v8_enabled(mocker: MockerFixture, infobase):
    """
...
@pytest.mark.asyncio
async def test_maintenance_info_base_calls_maintenance_pg_with_pg_enabled(mocker: MockerFixture, infobase):
    """
